...
const HELP = [
  ...
  { id: 'graphics', icon: '✨', title: 'Graphics & the map at scale', html: `
    <ul>
      ...
      <li><b>Only what is on screen is drawn at all</b> — armies, fleets, scouts, battles and borders elsewhere in the world cost nothing, and once the map is fully explored the fog stops being drawn.</li>
